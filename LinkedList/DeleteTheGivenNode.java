...
//Here the problem is that we have given the refernece of the deleted node and we don't given the head refernce so, our task is to delete that perticular node.
...
class Solution
{
    void deleteNode(Node del)
    {
         ...
         del.data = curr.data; // copy the value of curr in given node
